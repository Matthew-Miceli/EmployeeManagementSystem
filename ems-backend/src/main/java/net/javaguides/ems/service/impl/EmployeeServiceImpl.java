...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDto createEmployee(EmployeeDto employeeDto) {
        ...
        Department department = departmentRepository.findById(employeeDto.getDepartmentId()).orElseThrow(() ->
                new ResourceNotFoundException("Cannot find department with given id"));
    ...
    public EmployeeDto getEmployeeById(Long employeeId) {
        Employee employee = employeeRepository.findById(employeeId).orElseThrow(() ->
                new ResourceNotFoundException("Employee does not exist with given id: " +
                        employeeId));
    ...
    public EmployeeDto updateEmployee(Long employeeId, EmployeeDto updatedEmployee) {
        ...
        Department department = departmentRepository.findById(updatedEmployee.getDepartmentId()).orElseThrow(() -> new ResourceNotFoundException("Cannot find department with given id"));
        employee.setDepartment(department);
